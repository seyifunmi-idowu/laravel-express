        ...
        <tr>
          <td class="content">
            <table>
              <tr>
                <td>
                  <h1 class="intro-text">Account Suspension Notification</h1>
                  <p
                    style="
                      font-size: 14px;
                      line-height: 26px;
                  ...
                  >
                      ...
                      <br/>
                      <br/>
                      We regret to inform you that your account on [Platform/Service Name] has been temporarily suspended. This action has been taken due to:
                  </p>
                  <p>
                    {{ $suspend_reason }}
                  </p>
                  <p>
                    Your account will remain suspended until further notice. During this period, you will not be able to access your account or use our services.
                  </p>
                  ...
                  <p
                    ...
                    "
                  >
                    If you believe this suspension is a mistake or if you have any questions regarding this matter, please feel free to contact our support team.
